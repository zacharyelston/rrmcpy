#!/usr/bin/env python3
"""
Main entry point for the modular Redmine MCPServer
"""
import os
import logging
import sys
import time
from mcp_server_modular import RedmineMCPServer
...
def run_server():
    ...
    logger.info(f"Starting Modular Redmine MCPServer with URL: {redmine_url}")
